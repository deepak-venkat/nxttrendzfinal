...
class App extends Component {
  ...
  addCartItem = product => {
    this.setState(prevState => {
      ...
      const isProductExixts =
        cartList.find(eachProduct => eachProduct.id === product.id) !==
        undefined
      if (isProductExixts) {
        ...
        return {cartList: updatedProducts}
      }
  ...
  decrementCartItemQuantity = id => {
    this.setState(prevState => {
      ...
      const filteredProducts = updatedProducts.filter(
        eachProduct => eachProduct !== null,
      )
      return {cartList: filteredProducts}
    })
  }
